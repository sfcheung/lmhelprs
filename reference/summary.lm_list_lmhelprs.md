...
- ...:
  ...
  Other arguments. For the `summary` method, these are arguments to be
  passed to the `summary` method for each model (usually
  [`summary.lm()`](https://rdrr.io/r/stats/summary.lm.html)). For the
  `print` method, these are arguments to be passed to
